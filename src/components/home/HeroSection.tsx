...
export function HeroSection() {
  ...
  return (
    <motion.section
      className="relative text-center py-8 overflow-hidden min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-b from-background via-background to-card/5"
